        ...
        <Container>
          <Row className="py-5 align-items-center">
            <Col lg={6} className="mb-4 mb-lg-0">
              <h1 className="display-4 fw-bold mb-4">Find Your Perfect Job Match</h1>
              <p className="lead mb-4">
                Our AI-powered platform analyzes your skills and preferences to find the best job matches for you.
              </p>
              {isAuthenticated ? (
                <Link to="/dashboard" className="btn btn-light btn-lg px-4 me-3">
                  Go to Dashboard
                </Link>
              ) : (
