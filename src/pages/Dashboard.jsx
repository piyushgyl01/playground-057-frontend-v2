  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setError('Failed to load profile. Please create your profile to get job recommendations.');
      } finally {
      ...
      <Container className="py-4">
        <Card className="text-center p-5 shadow-sm">
          <Card.Body>
            ...
            <p className="mb-4">Please complete your profile to get personalized job recommendations.</p>
        ...
        <Col lg={4} className="mb-4">
          <Card className="shadow-sm h-100">
            ...
            <Card.Body>
              ...
              <div className="mb-3">
                <strong>Preferred Job Type:</strong> {profile.preferredJobType.charAt(0).toUpperCase() + profile.preferredJobType.slice(1)}
              </div>
                    ...
                    <Col md={12} className="mb-3" key={rec.id}>
                      <Card className="recommendation-card shadow-sm">
                        <Card.Body>
                          ...
                          <div className="mb-3">
                            <h6 className="text-muted">Why this is a good match:</h6>
                          ...
                          <div className="mb-3">
                            {rec.jobDetails.skills.map(skill => (
                              <Badge 
                                key={skill} 
                                bg={profile.skills.includes(skill) ? "success" : "light"}
                                text={profile.skills.includes(skill) ? "white" : "dark"}
                                className="me-1 mb-1"
                              >
                                {skill}
                              </Badge>
